 ...
 * *Базовая*
    ...
    * [Исходный код тестов](cljtest/parsing/ClojureObjectParsingTest.java)
 ...
 * *Variables*. Дополнительно реализовать поддержку:
    ...
    * [Исходный код тестов](cljtest/parsing/ClojureVariablesParsingTest.java)
 * *PowLog*. Дополнительно реализовать поддержку:
    ...
    * [Исходный код тестов](cljtest/parsing/ClojurePowLogParsingTest.java)
 ...
 * *Базовая*
    * Код должен находиться в файле `expression.clj`.
    * [Исходный код тестов](cljtest/object/ClojureObjectExpressionTest.java)
        * Запускать c аргументом `easy` или `hard`
 * *SinhCosh*. Дополнительно реализовать поддержку:
    * унарных операций:
        * `Sinh` (`sinh`) – гиперболический синус, `(sinh 3)` немного больше 10;
        * `Cosh` (`cosh`) – гиперболический косинус, `(cosh 3)` немного меньше 10.
    * [Исходный код тестов](cljtest/object/ClojureObjectSinhCoshTest.java)
 * *SquareSqrt*. Дополнительно реализовать поддержку:
    ...
    * [Исходный код тестов](cljtest/object/ClojureObjectSquareSqrtTest.java)
 ...
 * *Базовая*
    * Код должен находиться в файле `expression.clj`.
    * [Исходный код тестов](cljtest/functional/ClojureFunctionalExpressionTest.java)
        * Запускать c аргументом `easy` или `hard`
 * *SquareSqrt*. Дополнительно реализовать поддержку:
    * унарных операций:
        * `square` (`square`) – возведение в квадрат, `(square 3)` равно 9;
        * `sqrt` (`sqrt`) – извлечение квадратного корня из модуля аргумента, `(sqrt -9)` равно 3.
    * [Исходный код тестов](cljtest/functional/ClojureFunctionalSquareSqrtTest.java)
 * *MinMax*. Дополнительно реализовать поддержку:
    * операций:
        * `min` (`min`) – минимум, `(min 1 2 6)` равно 1;
        * `max` (`max`) – максимум, `(min 1 2 6)` равно 6;
    * [Исходный код тестов](cljtest/functional/ClojureFunctionalMinMaxTest.java)
 * *MedAvg*. Дополнительно реализовать поддержку:
    * операций:
        * `med` (`med`) – медиана, `(med 1 2 6)` равно 2;
        * `avg` (`max`) – среднее, `(min 1 2 6)` равно 3;
    * [Исходный код тестов](cljtest/functional/ClojureFunctionalMedAvgTest.java)
 ...
 * *Базовая*
    ...
    * Исходный код тестов
        * [Простой вариант](cljtest/linear/LinearBinaryTest.java)
        * [Сложный вариант](cljtest/linear/LinearNaryTest.java)
 * *Shapeless*
    ...
    * [Исходный код тестов](cljtest/linear/LinearShapelessTest.java)
 * *Tensor*
    ...
    * [Исходный код тестов](cljtest/linear/LinearTensorTest.java)
 * *Broadcast*
    * Назовем _тензором_ многомерную прямоугольную таблицу чисел.
    ...
    * [Исходный код тестов](cljtest/linear/LinearBroadcastTest.java)
 ...
 * *Базовая*
    ...
    * [Исходный код тестов](jstest/prefix/PrefixParserTest.java)
        * Запускать c аргументом `easy` или `hard`
 * *PrefixSumAvg*. Дополнительно реализовать поддержку:
    ...
    * [Исходный код тестов](jstest/prefix/PrefixSumAvgTest.java)
 * *PostfixSumAvg*. Дополнительно реализовать поддержку:
    ...
    * [Исходный код тестов](jstest/prefix/PostfixSumAvgTest.java)
 * *PrefixSumexpSoftmax*. Дополнительно реализовать поддержку:
    ...
    * [Исходный код тестов](jstest/prefix/PrefixSumexpSoftmaxTest.java)
 * *PostfixSumexpSoftmax*. Дополнительно реализовать поддержку:
    ...
    * [Исходный код тестов](jstest/prefix/PostfixSumexpSoftmaxTest.java)
 * *PostfixSumsqLength*. Дополнительно реализовать поддержку:
    ...
    * [Исходный код тестов](jstest/prefix/PostfixSumsqLengthTest.java)
 ...
 * *Базовая*
    * Код должен находиться в файле `objectExpression.js`.
    * [Исходный код тестов](jstest/object/ObjectExpressionTest.java)
 ...
 * *Базовая*
    ...
    * [Исходный код тестов](jstest/functional/FunctionalExpressionTest.java)
 ...
 * *PieAvgMed*. Дополнительно реализовать поддержку:
    ...
    * [Исходный код тестов](jstest/functional/FunctionalPieAvgMedTest.java)
        * Запускать c аргументом `hard`
 * *Variables*. Дополнительно реализовать поддержку:
    * переменных: `y`, `z`;
    * [Исходный код тестов](jstest/functional/FunctionalVariablesTest.java)
 ...
 * *OneIffAbs*. Дополнительно реализовать поддержку:
    ...
    * [Исходный код тестов](jstest/functional/FunctionalOneIffAbsTest.java)
        * Запускать c аргументом `hard`
 * *IffAbs*. Дополнительно реализовать поддержку:
    ...
    * операций:
        ...
        * `iff` – условный выбор:
            ...
            * `iff -1 -2 -3` равно -3
            * `iff 0 1 2` равно 1;
    * [Исходный код тестов](jstest/functional/FunctionalIffAbsTest.java)
        * Запускать c аргументом `hard`
 * *OneTwo*. Дополнительно реализовать поддержку:
    ...
    * констант:
        * `one` – 1;
        * `two` – 2;
    * [Исходный код тестов](jstest/functional/FunctionalOneTwoTest.java)
        * Запускать c аргументом `easy`
 ...
 * *Базовая*
    * Класс `GenericTabulator` должен реализовывать интерфейс
      [Tabulator](expression/generic/Tabulator.java) и
    ...
    * [Исходный код тестов](expression/generic/GenericTest.java)
 * *AsmUfb*
    ...
    * [Исходный код тестов](expression/generic/GenericAsmUfbTest.java)
 * *Ls*
    * Дополнительно реализовать поддержку режимов:
        * `l` – вычисления в `long` без проверки на переполнение;
        * `s` – вычисления в `short` без проверки на переполнение.
    * [Исходный код тестов](expression/generic/GenericLsTest.java)
 * *Ufb*
    * Дополнительно реализовать поддержку режимов:
        * `u` – вычисления в `int` без проверки на переполнение;
        * `f` – вычисления в `float` без проверки на переполнение;
        * `b` – вычисления в `byte` без проверки на переполнение.
    * [Исходный код тестов](expression/generic/GenericUfbTest.java)
 ...
 * *HighLow*
    ...
    * [Исходный код тестов](expression/exceptions/ExceptionsHighLowTest.java)
