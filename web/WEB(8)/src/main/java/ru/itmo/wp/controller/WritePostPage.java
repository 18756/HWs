...
import ru.itmo.wp.form.validator.PostCreateValidator;
...
public class WritePostPage extends Page {
    ...
    public WritePostPage(UserService userService, PostCreateValidator postCreateValidator) {
    ...
    public void initBinder(WebDataBinder binder) {
        binder.addValidators(postCreateValidator);
    }
